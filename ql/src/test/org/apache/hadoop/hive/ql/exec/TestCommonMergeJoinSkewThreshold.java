...
public class TestCommonMergeJoinSkewThreshold {
  ...
  @Test
  public void testInterval_skipsCheckOnNonBoundaryRows() throws HiveException {
  ...
  @Test
  public void testInterval_checksOnBoundaryRow() throws HiveException {
  ...
  @Test
  public void testInterval_alwaysChecksWhenRowCountExceedsThreshold() throws HiveException {
    SkewedMergeJoinMonitor monitor = new SkewedMergeJoinMonitor(500L, false, 10000L, 4);
    op.skewedMergeJoinMonitor = monitor;
  ...
  @Test
  public void testIsDueForCheck_boundaryAndThreshold() {
  ...
  @Test
  public void testSkewMessage_containsJoinKeyColumnsAndRowCount() {
